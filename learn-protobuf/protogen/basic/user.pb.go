...
type User struct {
	...
	// if the field infrequently used, we can use number older than 15
	Gender               Gender     `protobuf:"varint,16,opt,name=gender,proto3,enum=Gender" json:"gender,omitempty"` // this is enum field
	Emails               []string   `protobuf:"bytes,17,rep,name=emails,proto3" json:"emails,omitempty"`              // this is repeated field
...
var file_proto_basic_user_proto_rawDesc = []byte{
	...
	0x64, 0x12, 0x1f, 0x0a, 0x06, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x10, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x07, 0x2e, 0x47, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x52, 0x06, 0x67, 0x65, 0x6e, 0x64,
	0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x11, 0x20, 0x03,
	...
	0x10, 0x02, 0x42, 0x1f, 0x5a, 0x1d, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x2d, 0x70, 0x72, 0x6f, 0x74,
